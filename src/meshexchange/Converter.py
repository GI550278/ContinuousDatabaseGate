...
class Converter:
    """
    This class can be used to convert b3dm file to osgb, or to convert a complete set of children_tiles
    ...
    def stopConverters(self, num_of_reader_procs):
        ...
        print('\r', f'No more new children_tiles. Converting children_tiles in queue... {self.convertQueue.qsize()} children_tiles left', end='')
        while not self.convertQueue.empty():
            print('\r', f'No more new children_tiles. Converting children_tiles in queue... {self.convertQueue.qsize()} children_tiles left',
                  end='')
            time.sleep(1)
        print()
